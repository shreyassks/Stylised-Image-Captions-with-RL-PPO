...
def get_application():
    _app = FastAPI(title="image-captioning")
    _app.add_middleware(
        CORSMiddleware,
        allow_origins=["*"],
...
__C.INFERENCE.VOCAB = 'app/artifacts/coco_vocabulary.txt'

__C.INFERENCE.MODEL_PATH = 'app/artifacts/swin_transformer.pth'

__C.INFERENCE.DEVICE = 'cpu'
