...
def parse_opt():
    ...
    # Data input settings
    parser.add_argument('--input_json', type=str, default='data/personalised_captions/training_ids.json',
                    help='path to the json file containing information about images and captions')
    parser.add_argument('--metadata_json', type=str, default='data/personalised_captions/i2w_personality_mapping.json',
    ...
    parser.add_argument('--densecap_dir', type=str, default='data/dense_captions/training.h5',
                    help='path to the directory containing the dense captions for each image')
    parser.add_argument('--input_label_h5', type=str, default='data/coco_label.h5',
                    help='path to the h5file containing the preprocessed dataset')
    parser.add_argument('--input_label_start_idx', type=str, default='data/coco_label.h5',
                help='path to the h5file containing the preprocessed dataset')
    parser.add_argument('--input_label_end_idx', type=str, default='data/coco_label.h5',
            help='path to the h5file containing the preprocessed dataset')
    ...
    parser.add_argument('--cached_tokens', type=str, default='data/cider_words/person-train-idxs',
                    help='Cached token file for calculating cider score during self critical training.')
    parser.add_argument('--cider_optimization', type=int, default=1,
                    help='optimize cider?')
    ...
    parser.add_argument('--decoding_constraint', type=int, default=2,
    ...
    parser.add_argument('--save_checkpoint_every', type=int, default=363,
    ...
    parser.add_argument('--losses_log_every', type=int, default=363,
...
def add_eval_options(parser):
    ...
    parser.add_argument('--diversity_lambda', type=float, default=0.8,
